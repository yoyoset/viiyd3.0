...
| P6 | 档期文案 | `data/schedule.yaml` | "2026.11 起 · 两个展示位开放中" | 真实档期 | 用户 | ✅ 2026-09-26 用户确认无名额限制，档期块改「接单中」，schedule.yaml 已删 |
...
| P9 | 关于页资历四格 | `i18n/*.toml` `about_stat_*` | 2024 / 52 / 400+ / 2（设计稿占位） | 真实数字 | 用户 | ✅ 第 2–4 格改为实时计算（档案数 / 图片数 / 系统数），第 1 格 2024 为真实值 |
...
| P23 | 设备与工艺明细 | `i18n/*.toml` `about_kit_*` | 喷笔/光箱/地台三项写「待补充」 | 真实型号与品牌 | 用户 | ✅ 2026-09-26 用户决定整块删除，改为「出品」栏 |
