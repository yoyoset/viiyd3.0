...
summary: "死亡守卫的腐朽老兵，重点在战损质感与有机变异效果。"
share_caption: "二十只瘟疫战士，60 个小时，腐坏和变异比普通小队画得更狠一些。

这是军团体量的死亡守卫项目——高阶旧化和有机变异效果要在二十只模型上重复出说服力，还不能让哪一只看起来是复制上一只的。这个体量下，让脏污看起来是手作而不是模板化的，才是真正的功夫所在。

如果您的纳垢军团也需要整队这种程度的腐坏，这种体量我很乐意认真排进档期。"
...
<div class="bg-gradient-to-r from-neutral-800 to-transparent border-l-4 border-emerald-500 p-6 rounded-r-lg">
    <h3 class="text-xl font-bold text-white mb-2">🦠 作战定位: 老兵部署</h3>
    <p class="text-gray-300 leading-relaxed">
        针对高价值精英军队编制进行了优化。每一架模型都代表了在万年战争中获得“慈父纳垢宠爱”的资深战士。
    </p>
</div>
...
<div class="bg-neutral-800/30 p-5 rounded border border-cyan-500/20 hover:border-cyan-500/40 transition-colors">
    <div class="flex items-center justify-between mb-4 border-b border-white/5 pb-2">
        ...
        <span class="text-[10px] uppercase text-gray-500">涂装工艺</span>
    </div>
    ...
    <ul class="space-y-2 text-sm text-gray-300 list-disc list-inside marker:text-cyan-500">
        <li><strong>分层污垢：</strong> 多阶段洗漆，打造深邃且富有质感的阴影。</li>
        <li><strong>腐蚀金属：</strong> 使用 Typhus Corrosion 实现颗粒状的锈迹效果。</li>
        <li><strong>有机变异：</strong> 湿混粉色与紫色，表现血肉部分的细节。</li>
    </ul>
</div>
