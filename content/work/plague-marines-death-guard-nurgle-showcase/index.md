---
title: "Plague Marines: Death Guard Showcase"
...
<div class="bg-gradient-to-r from-neutral-800 to-transparent border-l-4 border-emerald-500 p-6 rounded-r-lg">
    <h3 class="text-xl font-bold text-white mb-2">🦠 Use Case: Veteran Deployment</h3>
    <p class="text-gray-300 leading-relaxed">
        Optimized for high-impact presence in elite army lists. Each model represents a veteran of ten thousand years of war, covered in the "gifts" of Grandfather Nurgle.
    </p>
</div>
...
<div class="bg-neutral-800/30 p-5 rounded border border-emerald-500/20 hover:border-emerald-500/40 transition-colors group">
    ...
    <ul class="space-y-3 text-sm text-gray-300">
        <li class="flex justify-between">
            <span>🤢 Plague Armor</span>
            <span class="font-mono text-emerald-200">Death Guard Green</span>
        </li>
        <li class="flex justify-between">
            <span>🦴 Rotten Bone</span>
            <span class="font-mono text-emerald-200">Rakarth Flesh</span>
        </li>
        <li class="flex justify-between">
            <span>🍯 Slime/Pus</span>
            <span class="font-mono text-emerald-200">Nurgle's Rot</span>
        </li>
    </ul>
</div>
...
<div class="bg-neutral-800/30 p-5 rounded border border-cyan-500/20 hover:border-cyan-500/40 transition-colors">
    ...
    <ul class="space-y-2 text-sm text-gray-300 list-disc list-inside marker:text-cyan-500">
        <li><strong>Layered Grime:</strong> Multi-stage washes for deep, textured shadows.</li>
        <li><strong>Corrosive Metal:</strong> Typhus Corrosion for granular rust texture.</li>
        <li><strong>Organic Mutations:</strong> Wet-blended pinks and purples for fleshy bits.</li>
    </ul>
</div>
