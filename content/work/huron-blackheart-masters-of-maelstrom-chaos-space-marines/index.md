...
<div class="bg-gradient-to-r from-neutral-800 to-transparent border-l-4 border-gold-500 p-6 rounded-r-lg">
    <h3 class="text-xl font-bold text-white mb-2">🔥 Use Case: Tabletop Supremacy</h3>
    <p class="text-gray-300 leading-relaxed">
        Engineered for maximum psychological impact on the tabletop. The Red Corsairs' iconic heraldry is rendered with tactical precision and weathered for an authentic raiding-fleet aesthetic.
    </p>
</div>
...
<div class="bg-neutral-800/30 p-5 rounded border border-emerald-500/20 hover:border-emerald-500/40 transition-colors group">
    ...
    <ul class="space-y-3 text-sm text-gray-300">
        <li class="flex justify-between">
            <span>🔴 Corsair Red</span>
            <span class="font-mono text-emerald-200">Khorne Red</span>
        </li>
        <li class="flex justify-between">
            <span>⚫ Void Black</span>
            <span class="font-mono text-emerald-200">Abaddon Black</span>
        </li>
        <li class="flex justify-between">
...
<div class="bg-neutral-800/30 p-5 rounded border border-cyan-500/20 hover:border-cyan-500/40 transition-colors">
    ...
    <ul class="space-y-2 text-sm text-gray-300 list-disc list-inside marker:text-cyan-500">
        <li><strong>Raider Weathering:</strong> Multi-stage sponging and streaks for a veteran look.</li>
        <li><strong>Warp-Glow OSL:</strong> Cyan high-lights on power weapons and the Hamadrya.</li>
        <li><strong>Micro-Decals:</strong> Precision application of Chaos iconography.</li>
    </ul>
</div>
