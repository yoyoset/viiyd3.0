...
share_caption: "十二只模型，72 个小时，两种不同的铳手统一进一套配色。

铁雹铳手和鹤铳手模型完全不同，但得共用一个身份——红衣、象牙白围巾、蓝头巾、银钢枪械，十二只模型上精确重复到位，队伍才能看出纪律感而不是拼凑感。

72 小时算是我接的单里偏大的体量——如果您的项目也是这个量级，这正是我更喜欢排的那种档期。"
...
{{< lightbox src="https://photo.viiyd.com/2026/09/cathayironhail/viiyd20260901cathayironhail_32.webp" title="火药之翼 完整收尾合照" >}}
</div>
